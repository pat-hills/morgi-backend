...
class EventPausedConnectionSuccess extends MixpanelEventBuilder
{
    public $type = 'paused_connection_success';
    ...
    public function __construct(int $user_id, array $frontend_properties)
    {
        ...
        $properties = [
            ...
            'Total paused connections' => $rookie_profile['Total paused connections'],
            'Total successful paused connections' => $rookie_profile['Total successful paused connections'],
    ...
    public function store(): void
    {
        try {
            parent::store();
            (new EventPausedConnectionSuccessForLeader($this->user->id, $this->properties))->store();
