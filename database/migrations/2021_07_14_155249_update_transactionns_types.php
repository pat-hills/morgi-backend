...
class UpdateTransactionnsTypes extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        $types = [
            ...
            ['type' => 'bought_micromorgi', 'lang' => 'EN', 'description_rookie' => 'Purchase of n.<amount_micromorgi> micromorgi (<amount_dollars> USD)',
                'description_leader' => 'Purchase of n.<amount_micromorgi> micromorgi (<amount_dollars> USD)'],
