...
class FixRonNotifications extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        try {
            ...
            NotificationType::where("type", "leader_buy_micromorgi_package")->update(["title" => "Congratulations!", "content" => "You’ve bought a package of <amount_micromorgi> Micro Morgis worth <amount> <currency>!"]);
            ...
            NotificationType::where("type", "leader_renewed_gift")->update(["title" => "Renewed gift!", "content" => "Your monthly gift to <ref_username> for <amount_morgi> Morgis has been renewed for this month."]);
            ...
            NotificationType::where("type", "rookie_receive_micromorgi")->update(["title" => "Congratulations!", "content" => "<ref_username> sent you a gift of <amount_micromorgi> Micro Morgis"]);
            ...
            NotificationType::where("type", "user_got_bonus")->update(["title" => "Bonus from Morgi!", "content" => "Congratulations, you just got a bonus of <amount_micromorgi> Micro Morgis from Morgi!"]);
            NotificationType::where("type", "rookie_got_bonus")->update(["title" => "Bonus from Morgi!", "content" => "Congratulations, you just got a bonus of <amount_morgi> Morgis from us at Morgi!"]);
            ...
            NotificationType::where("type", "rookie_new_gift")->update(["title" => "Congratulations!", "content" => "<ref_username> has gifted you with a MOnthly Recurring GIft of <amount_morgi> Morgis. SAY THANKS😊!"]);
            NotificationType::where("type", "leader_new_gift")->update(["title" => "Congratulations!", "content" => "You successfully gifted <ref_username> with <amount_morgi> Morgis!"]);
            NotificationType::where("type", "rookie_renewed_gift")->update(["title" => "Renewed gift!", "content" => "<ref_username> is once again gifting you with <amount_morgi> Morgis per month!. SAY THANKS 😊!"]);
