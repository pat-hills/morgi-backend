...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-4" style="text-align: right">
            <a href="{{route('user.edit.active_gifts', $user->id)}}" type="button" class="btn btn-primary"
               style="color: white">
                <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" fill="currentColor"
                     class="bi bi-circle-fill" viewBox="0 0 16 16" style="color: limegreen">
                    <circle cx="8" cy="8" r="8"/>
                </svg>
                Active subscriptions ({{$opposite_subscriptions_counter}})</a>
        </div>
        <div class="col-4" style="text-align: left">
            <a href="{{route('user.edit.active_gifts.not-active-gifts', $user->id)}}" type="button"
               class="btn btn-primary active">Inactive subscriptions ({{count($subscriptions)}})</a>
        </div>
    </div>
    <br>
    <br>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <table id="notActiveTable" class="table table-condensed" style="border-collapse:collapse;">
